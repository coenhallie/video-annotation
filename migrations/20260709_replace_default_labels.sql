...
FROM (VALUES
  ...
  ('PLY WRONG POS', 'The player exists but is clearly in the wrong position on the pitch.', '#06b6d4'),
  ('PLY AS NPL', 'The player has been incorrectly categorized as a non-player official.', '#0891b2'),
  ('PLY KEEPER WRONG POS', 'A goal keeper class player is in a seriously wrong position.', '#0e7490'),
