<template>
  ...
  >
    ...
    >
      <div
        class="rounded border border-gray-200 bg-white px-3 py-2 shadow-lg dark:border-white/10 dark:bg-gray-900"
      >
        <span class="text-[12px] text-gray-700 dark:text-gray-200">Loading drawings…</span>
      </div>
    </div>
  </div>
</template>
