...
const changelogEntries = ref([
  ...
  },
  {
    ...
    changes: [
      ...
      'New comparison: upload a video file straight from the picker for either side, so a comparison no longer depends on the pipeline having processed both videos',
