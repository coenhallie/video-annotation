...
export class VideoService {
  static async createVideo(videoData: VideoInsert) {
    ...
    // First try to find existing video by URL and owner
    ...
    if (existingVideo) {
      console.log(
        '🔍 [VideoService] Found existing video, updating:',
        existingVideo.id
      );
    ...
    console.log('🔍 [VideoService] No existing video found, creating new one');
